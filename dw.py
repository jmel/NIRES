...
unit = open(globals.codepath +'calibrations/tspec_wavelength1.reg','w')
...
try:
    yy,xx,lam=rc.readcol(globals.codepath +'calibrations/tspec_wavelength_file_iraf.dat',names=False,twod=False)
