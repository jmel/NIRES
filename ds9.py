...
class ds9:
	...
	def wavedisp(self):
		...
		self.xpaset("regions "+ globals.codepath + "calibrations/tspec_wavelength1.reg") #set path from globals.py
                self.xpaset("regions "+ globals.codepath + "calibrations/tspec_wavelength.reg") #set path from globals.py
